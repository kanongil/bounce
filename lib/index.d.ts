...
export function ignore<T extends abstract new (...args: any) => Error>(err: any, types: T, options: { return?: false | undefined }): asserts err is InstanceType<T>;
export function ignore<T extends abstract new (...args: any) => Error>(err: any, types: T): asserts err is InstanceType<T>;
